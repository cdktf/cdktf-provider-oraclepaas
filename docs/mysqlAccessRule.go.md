...
```go
import "github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v3/mysqlaccessrule"
...
&mysqlaccessrule.MysqlAccessRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	Timeouts: github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v3.mysqlAccessRule.MysqlAccessRuleTimeouts,
}
```

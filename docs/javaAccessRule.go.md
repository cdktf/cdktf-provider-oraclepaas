...
```go
import "github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v4/javaaccessrule"
...
&javaaccessrule.JavaAccessRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	Timeouts: github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v4.javaAccessRule.JavaAccessRuleTimeouts,
}
```

// https://registry.terraform.io/providers/hashicorp/oraclepaas/1.5.3/docs/resources/database_access_rule
...
export interface DatabaseAccessRuleConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function databaseAccessRuleTimeoutsToTerraform(struct?: DatabaseAccessRuleTimeouts | cdktf.IResolvable): any {
...
export function databaseAccessRuleTimeoutsToHclTerraform(struct?: DatabaseAccessRuleTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DatabaseAccessRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DatabaseAccessRuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DatabaseAccessRuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DatabaseAccessRule extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "oraclepaas_database_access_rule";
  ...
  * @param importToId The construct id used in the generated config for the DatabaseAccessRule to import
  * @param importFromId The id of the existing DatabaseAccessRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oraclepaas/1.5.3/docs/resources/database_access_rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DatabaseAccessRule to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "oraclepaas_database_access_rule", importId: importFromId, provider });
      }
  ...
  * @param options DatabaseAccessRuleConfig
  */
  public constructor(scope: Construct, id: string, config: DatabaseAccessRuleConfig) {
    super(scope, id, {
      terraformResourceType: 'oraclepaas_database_access_rule',
  ...
  private _timeouts = new DatabaseAccessRuleTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DatabaseAccessRuleTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: databaseAccessRuleTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: databaseAccessRuleTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DatabaseAccessRuleTimeouts",
      },
    };

...
```go
import "github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v8/databaseaccessrule"
...
&databaseaccessrule.DatabaseAccessRuleConfig {
	...
	Enabled: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v8.databaseAccessRule.DatabaseAccessRuleTimeouts,
}
```

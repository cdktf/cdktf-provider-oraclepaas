...
```go
import "github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v8/javaaccessrule"
...
&javaaccessrule.JavaAccessRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	Timeouts: github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v8.javaAccessRule.JavaAccessRuleTimeouts,
}
```

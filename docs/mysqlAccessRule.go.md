...
```go
import "github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v8/mysqlaccessrule"
...
&mysqlaccessrule.MysqlAccessRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	Timeouts: github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v8.mysqlAccessRule.MysqlAccessRuleTimeouts,
}
```

...
```go
import "github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v6/javaaccessrule"
...
&javaaccessrule.JavaAccessRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	Timeouts: github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v6.javaAccessRule.JavaAccessRuleTimeouts,
}
```

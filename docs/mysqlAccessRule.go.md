...
```go
import "github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v6/mysqlaccessrule"
...
&mysqlaccessrule.MysqlAccessRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	Timeouts: github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v6.mysqlAccessRule.MysqlAccessRuleTimeouts,
}
```

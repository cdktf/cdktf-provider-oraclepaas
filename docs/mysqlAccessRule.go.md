...
```go
import "github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v5/mysqlaccessrule"
...
&mysqlaccessrule.MysqlAccessRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	Timeouts: github.com/cdktf/cdktf-provider-oraclepaas-go/oraclepaas/v5.mysqlAccessRule.MysqlAccessRuleTimeouts,
}
```
